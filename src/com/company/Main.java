...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        //Arr1 adds info for emp1 etc
        arr1.add(emp1);
        arr2.add(emp2);
        arr3.add(emp3);

        //Create the arraylists pass info for Job.
        ArrayList<Job> jobarr1= new ArrayList();
        ArrayList<Job> jobarr2= new ArrayList();
        ArrayList<Job> jobarr3= new ArrayList();

        /*
        * Department has already a property of Masters -->  emp4,emp5 ,emp6 without the need to create Arraylists
        * Department HAS Jobs so, I pass the Job info to arraylists
        */
        // Creation of Department type objects
        ...
        // I getEmployees info from a Department and pass it to Job Hashmap
